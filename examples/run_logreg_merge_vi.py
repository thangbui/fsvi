...
# python run_logreg_merge_vi.py --homogeneous=True --space_client="function_sampling" --no_clients=2
# python run_logreg_merge_vi.py --homogeneous=False --space_client="function_sampling" --no_clients=2
